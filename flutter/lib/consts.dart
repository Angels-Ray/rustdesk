...
const String kOptionP2pLegacyNonPublicUdpDefault =
    "p2p-legacy-non-public-udp-default";
const String kOptionP2pUdpPortReadyMinMs = "p2p-udp-port-ready-min-ms";
const String kOptionP2pUdpPortReadyMaxMs = "p2p-udp-port-ready-max-ms";
const String kOptionP2pDirectBudgetMs = "p2p-direct-budget-ms";
const String kOptionP2pDirectGraceMs = "p2p-direct-grace-ms";
const String kOptionP2pRelayCommitDeadlineMs = "p2p-relay-commit-deadline-ms";
const String kOptionP2pUdpBudgetPackets = "p2p-udp-budget-packets";
const String kOptionP2pEasysymWindow = "p2p-easysym-window";
const String kOptionP2pHardSymFastFallbackMs = "p2p-hardsym-fast-fallback-ms";
const String kOptionP2pPathCacheTtlSec = "p2p-path-cache-ttl-sec";
const String kOptionP2pCircuitBreakFailures = "p2p-circuit-break-failures";
const String kOptionP2pOrchestratorV2 = "p2p-orchestrator-v2";
const String kOptionP2pNatProfileV2 = "p2p-nat-profile-v2";
const String kOptionP2pEasysymV1 = "p2p-easysym-v1";
const String kOptionP2pPathMemoryV1 = "p2p-path-memory-v1";
