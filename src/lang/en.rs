...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("P2P", "P2P"),
        ("P2P Advanced", "P2P Advanced"),
        ("UDP Punch", "UDP Punch"),
        ("IPv6 Punch", "IPv6 Punch"),
        ("Direct budget", "Direct budget"),
        ("Direct grace", "Direct grace"),
        ("Relay deadline", "Relay deadline"),
        ("UDP wait min", "UDP wait min"),
        ("UDP wait max", "UDP wait max"),
        ("UDP budget", "UDP budget"),
        ("EasySym window", "EasySym window"),
        ("HardSym fallback", "HardSym fallback"),
        ("Path memory", "Path memory"),
        ("Circuit breaker", "Circuit breaker"),
        ("Orchestrator v2", "Orchestrator v2"),
        ("NAT profile", "NAT profile"),
        ("Non-public default", "Non-public default"),
        ("Prefer UDP direct. Disable to always relay. Default on.", "Prefer UDP direct. Disable to always relay. Default on."),
        ("Allow IPv6 direct attempt. IPv6 unavailable does not affect IPv4.", "Allow IPv6 direct attempt. IPv6 unavailable does not affect IPv4."),
        ("Direct total budget. Too small forces relay. Default 8000ms. Range 1000-60000.", "Direct total budget. Too small forces relay. Default 8000ms. Range 1000-60000."),
        ("Direct grace window. Relay is not committed within this window. Default 600ms. Range 100-5000.", "Direct grace window. Relay is not committed within this window. Default 600ms. Range 100-5000."),
        ("Relay commit deadline. Default 1800ms. Range 200-10000.", "Relay commit deadline. Default 1800ms. Range 200-10000."),
        ("UDP port ready min. Actual wait is RTT/2 clamped. Default 250ms. Range 50-5000.", "UDP port ready min. Actual wait is RTT/2 clamped. Default 250ms. Range 50-5000."),
        ("UDP port ready max. Actual wait is RTT/2 clamped. Default 1200ms. Range 50-5000.", "UDP port ready max. Actual wait is RTT/2 clamped. Default 1200ms. Range 50-5000."),
        ("UDP probe packet budget. Default 32. Range 4-256.", "UDP probe packet budget. Default 32. Range 4-256."),
        ("EasySym prediction window. Default 7. Range 1-32.", "EasySym prediction window. Default 7. Range 1-32."),
        ("HardSym fast fallback threshold. Default 300ms. Range 100-5000.", "HardSym fast fallback threshold. Default 300ms. Range 100-5000."),
        ("Path cache TTL. Default 60s. Range 5-3600.", "Path cache TTL. Default 60s. Range 5-3600."),
        ("Direct failure threshold for circuit breaker. Default 3. Range 1-10.", "Direct failure threshold for circuit breaker. Default 3. Range 1-10."),
        ("New connection orchestrator. Disable to fallback legacy.", "New connection orchestrator. Disable to fallback legacy."),
        ("Enable local NAT profile strategy. Disable to fallback legacy.", "Enable local NAT profile strategy. Disable to fallback legacy."),
        ("Enable EasySym predicted ports.", "Enable EasySym predicted ports."),
        ("Enable path memory and failure hints.", "Enable path memory and failure hints."),
        ("Non-public relay default disables UDP/IPv6 when unset.", "Non-public relay default disables UDP/IPv6 when unset."),
        ("Disable UDP completely. Use TCP/relay only.", "Disable UDP completely. Use TCP/relay only."),
