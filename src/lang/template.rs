...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Relay commit deadline. Default 1800ms. Range 200-10000.", ""),
        ...
        ("UDP probe packet budget. Default 32. Range 4-256.", ""),
        ("EasySym prediction window. Default 7. Range 1-32.", ""),
        ("HardSym fast fallback threshold. Default 300ms. Range 100-5000.", ""),
        ("Path cache TTL. Default 60s. Range 5-3600.", ""),
        ...
        ("Disable UDP completely. Use TCP/relay only.", ""),
        ("Invalid value", ""),
        ("Empty = default", ""),
        ("Continue with {}", ""),
        ("Display Name", ""),
